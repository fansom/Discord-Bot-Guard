...
function Write-Log {
    ...
    # 寫入日誌檔案
    $logFile = ".dev-flow/logs/$(Get-Date -Format 'yyyy-MM-dd').log"
...
# 4.6 minimax-helper-watcher.ps1
$minimaxWatcher = @'
# ============================================
...
Write-Host "Press Ctrl+C to stop this script (watchers will continue running)" -ForegroundColor Yellow
Write-Host ""
...
# 5.2 to-verification-template.md
...
Write-Host "   - AI-Collaboration-System-SA.md" -ForegroundColor White
Write-Host "   - AI-Collaboration-System-SD.md" -ForegroundColor White
Write-Host ""
